...
#include "keymap_euro_german_programmer.h"
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT(
        ...
        KC_GRV,         EU_1,           EU_2,           EU_3,           EU_4,           EU_5,           EU_6,           EU_7,           EU_8,           EU_9,           EU_0,           EU_UNDS,        EU_ACUT,        KC_BSPC,        KC_HOME,
        KC_TAB,         EU_Q,           EU_W,           EU_E,           EU_R,           EU_T,           EU_Y,           EU_U,           EU_I,           EU_O,           EU_P,           EU_LCBR,        EU_RCBR,        EU_PLUS,        KC_PGUP,
    ...
    [_MOD] = LAYOUT(
        ...
        KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          EU_HASH,        DM_REC2,
        KC_TRNS,        KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,                          KC_NO,          DM_PLY1, 
        KC_LSFT,                        KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_RSFT,        KC_UP,          DM_PLY2,
...
const uint16_t PROGMEM eqbrc_combo[] = {EU_0, EU_DOT, COMBO_END};
    ...
    switch(combo_index) {
        case X_LMDA:
            if (pressed) {
                tap_code(EU_X);
                tap_code(KC_SPC);
                SEND_STRING(SS_ALGR(SS_TAP(X_KP_6) SS_TAP(X_KP_1)));
                SEND_STRING(SS_ALGR(SS_TAP(X_KP_6) SS_TAP(X_KP_2)));
                tap_code(KC_SPC);
                tap_code(EU_X);
                tap_code(EU_DOT);
            }
